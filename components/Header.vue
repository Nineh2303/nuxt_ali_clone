<template>
  <div id="TopMenu"
       class="w-full bg-[#FAFAFA] border-d md:block hidden">
    <ul class="flex items-center justify-end text-xs text-[#333333] font-light px-2 h-10 bg-[#FAFAFA] max-w-[1200px]">
      ...
      <li
          ...
          class="relative flex items-center p-2.5 hover:text-[#FF4646] h-full cursor-pointer"
      ...
      >
        ...
        Account
        <Icon name="mdi:chevron-down" size="15" ml-5/>
        <div
            id="AccountMenu"
            v-if="isAccountMenu"
            class="absolute bg-white w-[220px] text-[#333333] z-40 top-[38px] -left-[100px] border-x border-b">
          <div v-if="true">
            <div class="text-semi-bold text-[15px] my-4 px-3"> Welcome to AliExpress!</div>
            ...
            <div v-if="false" class="p-1">
              <NuxtLink
                ...
                <div class="flex items-center">
                  <img src="https://picsum.photos/id/82/300/300" alt="" class="rouded-md" width="40">
